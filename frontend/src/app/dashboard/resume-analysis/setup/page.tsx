...
export default function ResumeAnalysisSetupPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      formData.append("session_type", "analysis");
      ...
      setError(message || "Failed to setup analysis session.");
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="max-w-3xl mx-auto">
      <div className="mb-8">
        ...
        <h1 className="text-3xl font-bold text-slate-900">Resume Analysis Setup</h1>
        <p className="mt-2 text-slate-600">Upload your resume to get deep insights and ATS optimization tips.</p>
      </div>
      ...
      <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
        <form onSubmit={handleSubmit} className="p-8 space-y-8">
          ...
          <div>
            <label className="block text-sm font-semibold text-slate-900 mb-3">2. Target Job Description (Optional)</label>
            <textarea
              rows={6}
              ...
              placeholder="Paste the job description to get tailored ATS suggestions..."
